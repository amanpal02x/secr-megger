...
export default function Login() {
  const { login, sendOtp, loginWithOtp, resetPassword } = useAuth();
  ...
  const [techLoginSubMode, setTechLoginSubMode] = useState('otp'); // 'otp' or 'creds'
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center p-4 transition-colors duration-500 bg-slate-100">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden border border-slate-200">
        ...
        <div className="px-8 pt-8 pb-6 text-center">
          ...
          <h2 className="text-2xl font-black text-navy-900 tracking-tight">
            Staff & Controller Login
          </h2>
          <p className="text-sm text-slate-500 mt-1">
            Secure Entry for Technical & Administrative Personnel
          </p>
        </div>
        ...
        <div className="px-8 pb-8">
          {view === 'forgot' ? (
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
              ...
              {error && (
                <div className="p-3 text-xs font-bold rounded-lg border bg-amber-50 text-amber-700 border-amber-100 flex items-center gap-2">
              ...
              {success && (
                <div className="p-3 text-xs font-bold rounded-lg border bg-green-50 text-green-700 border-green-100 flex items-center gap-2">
                  <svg className="w-4 h-4 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
              ...
              <form onSubmit={otpSent ? handleResetPassword : handleSendOtp} className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <div className="relative group">
                    <input
                      ...
                      className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3.5 pl-11 text-sm outline-none transition-all focus:ring-2 focus:ring-navy-800 disabled:opacity-50"
                      required
                    />
                    <svg className="w-5 h-5 text-slate-400 absolute left-4 top-1/2 -translate-y-1/2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeWidth="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z"></path>
                    </svg>
                  </div>
                </div>
                  ...
                  <>
                    <div className="space-y-1.5 animate-in fade-in slide-in-from-top-2">
                      ...
                      <input
                        ...
                        placeholder="••••••"
                        maxLength={6}
                        className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3.5 text-sm outline-none focus:ring-2 focus:ring-navy-800 text-center tracking-[1em] font-bold"
                        required
                      />
                    </div>
                    <div className="space-y-1.5 animate-in fade-in slide-in-from-top-2">
                      ...
                      <input
                        ...
                        className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3.5 text-sm outline-none focus:ring-2 focus:ring-navy-800"
                        required
                      />
                    </div>
                  </>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-navy-900 hover:bg-navy-800 text-white font-black py-4 rounded-xl shadow-lg transition-all active:scale-95 text-sm uppercase tracking-widest"
                >
                ...
                <button
                  ...
                  className="w-full text-[10px] font-bold text-slate-400 hover:text-navy-900 uppercase tracking-widest transition-colors"
                >
                  Back to Login
                </button>
              </form>
            ...
            <>
              {error && (
                <div className="p-3 text-xs font-bold rounded-lg border flex items-center gap-2 bg-amber-50 text-amber-700 border-amber-100 mb-4">
                  <svg className="w-4 h-4 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clipRule="evenodd"></path>
                  </svg>
                  {error}
              ...
              {success && (
                <div className="p-3 text-xs font-bold rounded-lg border bg-green-50 text-green-700 border-green-100 flex items-center gap-2 mb-4">
                  <svg className="w-4 h-4 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
                  </svg>
                  {success}
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative group">
                        <input
                          ...
                          placeholder="username@secr.gov.in"
                      ...
                      <div className="flex justify-between items-center px-1">
                        {otpSent ? (
                          <button
                            ...
                            className="text-[10px] font-bold text-navy-600 uppercase tracking-tight hover:underline"
                          >
                            Change Number
                          </button>
                        ) : (
